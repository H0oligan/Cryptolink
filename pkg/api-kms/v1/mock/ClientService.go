...
import (
	...
	wallet "github.com/cryptolink/cryptolink/pkg/api-kms/v1/client/wallet"
)
...
// CreateMoneroTransaction provides a mock function with given fields: params, opts
func (_m *ClientService) CreateMoneroTransaction(params *wallet.CreateMoneroTransactionParams, opts ...wallet.ClientOption) (*wallet.CreateMoneroTransactionCreated, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *wallet.CreateMoneroTransactionCreated
	var r1 error
	if rf, ok := ret.Get(0).(func(*wallet.CreateMoneroTransactionParams, ...wallet.ClientOption) (*wallet.CreateMoneroTransactionCreated, error)); ok {
		return rf(params, opts...)
	}
	if rf, ok := ret.Get(0).(func(*wallet.CreateMoneroTransactionParams, ...wallet.ClientOption) *wallet.CreateMoneroTransactionCreated); ok {
		r0 = rf(params, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*wallet.CreateMoneroTransactionCreated)
		}
	}

	if rf, ok := ret.Get(1).(func(*wallet.CreateMoneroTransactionParams, ...wallet.ClientOption) error); ok {
		r1 = rf(params, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
// CreateSolanaTransaction provides a mock function with given fields: params, opts
func (_m *ClientService) CreateSolanaTransaction(params *wallet.CreateSolanaTransactionParams, opts ...wallet.ClientOption) (*wallet.CreateSolanaTransactionCreated, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *wallet.CreateSolanaTransactionCreated
	var r1 error
	if rf, ok := ret.Get(0).(func(*wallet.CreateSolanaTransactionParams, ...wallet.ClientOption) (*wallet.CreateSolanaTransactionCreated, error)); ok {
		return rf(params, opts...)
	}
	if rf, ok := ret.Get(0).(func(*wallet.CreateSolanaTransactionParams, ...wallet.ClientOption) *wallet.CreateSolanaTransactionCreated); ok {
		r0 = rf(params, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*wallet.CreateSolanaTransactionCreated)
		}
	}

	if rf, ok := ret.Get(1).(func(*wallet.CreateSolanaTransactionParams, ...wallet.ClientOption) error); ok {
		r1 = rf(params, opts...)
	} else {
		r1 = ret.Error(1)
	}
