...
func TestBalanceRoutes(t *testing.T) {
	...
	tc.Providers.PriceFeedMock.SetupRates(ethUSDT.Ticker, money.USD, 1)
	tc.Providers.PriceFeedMock.SetupRates(eth.Ticker, money.USD, 1800)
	tc.Providers.PriceFeedMock.SetupRates(matic.Ticker, money.USD, 1)
