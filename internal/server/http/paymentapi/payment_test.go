...
func TestHandlers(t *testing.T) {
	...
	t.Run("GetPayment", func(t *testing.T) {
		...
		t.Run("Returns payment with paymentMethod", func(t *testing.T) {
			...
			tc.Providers.PriceFeedMock.SetupRates(ticker, money.USD, 1300)
			...
			t.Run("Returns updated payment method", func(t *testing.T) {
				...
				tc.Providers.PriceFeedMock.SetupRates(ticker, money.USD, 0.83)
	...
	t.Run("LockPaymentOptions", func(t *testing.T) {
		...
		for _, testCase := range testCases {
			t.Run(testCase.name, func(t *testing.T) {
				...
				if testCase.ticker != "" {
					tc.Providers.PriceFeedMock.SetupRates(testCase.ticker, money.USD, 1)
