...
func TestService_BatchCreateInternalTransfers(t *testing.T) {
	...
	// Mock exchange rates
	tc.Providers.PriceFeedMock.SetupRates("ETH", money.USD, 1600)
	tc.Providers.PriceFeedMock.SetupRates("ETH_USDT", money.USD, 1)
	tc.Providers.PriceFeedMock.SetupRates("TRON", money.USD, 0.066)
	tc.Providers.PriceFeedMock.SetupRates("BNB", money.USD, 240)
